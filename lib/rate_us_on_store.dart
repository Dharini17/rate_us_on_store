...
class RateUsOnStore {
  ...
  RateUsOnStore({required this.androidPackageName,required this.appstoreAppId});

  launch() async {
    String strURL = Platform.isAndroid ? "https://play.google.com/store/apps/details?id=$androidPackageName" :
